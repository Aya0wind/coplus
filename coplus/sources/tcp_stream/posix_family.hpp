...
#include "coplus/network/tcp/socket.hpp"
...
namespace coplus {
    ...
    class socket_read_awaiter : public detail::source_base<selector, socket_read_awaiter<IP>> {
        ...
        void register_event_impl(selector& selector, token_type token) const {
            selector.register_event(_socket.raw_handle(), Interest::READABLE, 0, (void*) token);
        }
    ...
    public:
        ...
        void await_suspend(co_handle<void> handle) {
            current_worker_context.register_event(*this, _socket.raw_handle());
        ...
        size_t await_resume() {
            ...
            current_worker_context.deregister_event(*this);
            int read_result = _socket.read_to_end(_context);
    ...
    public:
        ...
        void register_event_impl(selector& selector, token_type token) const {
            selector.register_event(_socket.raw_handle(), Interest::WRITEABLE, 0, (void*) token);
        }
    ...
    public:
        ...
        [[nodiscard]] const net_address<IP> target_address() const {
            return _address;
        }
